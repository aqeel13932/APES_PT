...
parser.add_argument('--episodes', type=int, default=1000)# much more ( 1000 -> 10,000) (should be around 1 million steps)
...
parser.add_argument('--train_m',type=str,default='1076')
parser.add_argument('--naction',type=int,default=4)
