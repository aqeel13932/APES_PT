...
#2019/12/17 15:13 This file updated so allo-centric use ego-centric actions and ego-centric use allo-centric actions.
import argparse
...
def GenerateSettingsLine():
    ...
    line.append(args.Ego)
    line.append(args.Level)
